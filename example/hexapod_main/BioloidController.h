...
//Define max number of servos that can be controlled. 25 I think?
#define AX12_MAX_SERVOS           25

// Define a global variable for the start time of thr program
...
/** Bioloid Controller Class for mega324p/644p clients. **/
  ...
  public:
    ...
    BioloidController(long baud);               // baud usually 1000000bps or 1Mbps
